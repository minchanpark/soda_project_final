        ...
        child: ListView(
          children: const [
            SizedBox(
              ...
              height: 305,
              child: Image(
                  fit: BoxFit.fitWidth, image: AssetImage('assets/place.png')),
            ),
            Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            '“기름이 튈까! 냄새가 밸까? 뒷정리는 언제하지?”이런 걱정은',
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.w500,
                                letterSpacing: -0.225,
                ...
                children: [
                  Text('메뉴',
                      style: TextStyle(
                          ...
                          height: 1.1)),
                  SizedBox(height: 10),
                  Image(image: AssetImage('assets/place_1.png')),
                ],
              ),
            ),
            SizedBox(height: 14),
