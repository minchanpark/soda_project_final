...
class TapPage5Cafe extends StatelessWidget {
  const TapPage5Cafe({super.key});
        ...
        child: ListView(
          children: const [
            SizedBox(
              ...
              height: 305,
              child: Image(
                  fit: BoxFit.fitWidth, image: AssetImage('assets/mond.png')),
            ),
            Row(
                ...
                children: [
                  Text('메뉴',
                      style: TextStyle(
                          ...
                          height: 1.1)),
                  SizedBox(height: 10),
                  Image(image: AssetImage('assets/mondmenu.png')),
                ],
              ),
            ),
            SizedBox(height: 14),
