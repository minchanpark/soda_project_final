...
class TapPage4Enter extends StatelessWidget {
  const TapPage4Enter({super.key});
        ...
        child: ListView(
          children: const [
            SizedBox(
              ...
              child: Image(
                  fit: BoxFit.fitWidth,
                  image: AssetImage('assets/spaceimage.png')),
            ),
            Row(
                ...
                children: [
                  Text('가격',
                      style: TextStyle(
                          ...
                          height: 1.1)),
                  SizedBox(height: 10),
                  Image(image: AssetImage('assets/spaceprice.png')),
                ],
              ),
            ),
            SizedBox(height: 14),
