...
class TapPage1Enter extends StatelessWidget {
  const TapPage1Enter({super.key});
        ...
        child: ListView(
          children: const [
            SizedBox(
              ...
              child: Image(
                  fit: BoxFit.fitWidth,
                  image: AssetImage('assets/ballingimage.png')),
            ),
            Row(
                ...
                children: [
                  Text('메뉴',
                      style: TextStyle(
                          ...
                          height: 1.1)),
                  SizedBox(height: 10),
                  Image(image: AssetImage('assets/ball.png')),
                ],
              ),
            ),
            SizedBox(height: 14),
